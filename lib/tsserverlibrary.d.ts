...
declare namespace ts.server {
    ...
    export function convertScriptKindName(scriptKindName: protocol.ScriptKindName): ScriptKind.Unknown | ScriptKind.JS | ScriptKind.JSX | ScriptKind.TS | ScriptKind.TSX | ScriptKind.ETS;
...
declare namespace ts {
    namespace ArkTSLinter_1_1 {
        namespace Utils {
            ...
            function getWithStatementHighlightRange(nodeOrComment: Node | CommentRange): [number, number] | undefined;
            function getDeleteOperatorHighlightRange(nodeOrComment: Node | CommentRange): [number, number] | undefined;
            function getTypeQueryHighlightRange(nodeOrComment: Node | CommentRange): [number, number] | undefined;
            function getInstanceofUnsupportedHighlightRange(nodeOrComment: Node | CommentRange): [number, number] | undefined;
            function getConstAssertionHighlightRange(nodeOrComment: Node | CommentRange): [number, number] | undefined;
            function getLimitedReturnTypeInferenceHighlightRange(nodeOrComment: Node | CommentRange): [number, number] | undefined;
            function getLocalFunctionHighlightRange(nodeOrComment: Node | CommentRange): [number, number] | undefined;
            function getFunctionApplyCallHighlightRange(nodeOrComment: Node | CommentRange): [number, number] | undefined;
            ...
            function findParentIf(asExpr: AsExpression): IfStatement | null;
            function isDestructuringAssignmentLHS(tsExpr: ArrayLiteralExpression | ObjectLiteralExpression): boolean;
            function isEnumType(tsType: ts.Type): boolean;
            ...
            function destructuringAssignmentHasSpreadOperator(node: ts.AssignmentPattern): boolean;
            ...
            function destructuringDeclarationHasSpreadOperator(node: ts.BindingPattern): boolean;
            function hasNestedObjectDestructuring(node: ts.ArrayBindingOrAssignmentPattern): boolean;
...
declare namespace ts {
    namespace ArkTSLinter_1_1 {
        ...
        class TypeScriptLinter {
            ...
            static useRelaxedRules: boolean;
            static initGlobals(): void;
            static initStatic(): void;
            static tsTypeChecker: TypeChecker;
            currentErrorLine: number;
            ...
            private handleInterfaceDeclaration;
            private handleThrowStatement;
            private checkForLoopDestructuring;
            private handleForStatement;
            private handleForInStatement;
            private handleForOfStatement;
            private handleImportDeclaration;
            ...
            private handleVariableDeclarationList;
            private handleVariableDeclaration;
            private handleDeclarationDestructuring;
            private checkVarDeclForDuplicateNames;
            private handleEsObjectDelaration;
            private handleEsObjectAssignment;
            private handleCatchClause;
            private handleClassDeclaration;
