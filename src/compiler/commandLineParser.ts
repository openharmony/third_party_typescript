import {
    ...
    ParsedCommandLine, parseJsonText, Path, PerformanceDotting, PollingWatchKind, PrefixUnaryExpression, ProjectReference, PropertyName,
...
export function parseJsonSourceFileConfigFileContent(sourceFile: TsConfigSourceFile, host: ParseConfigHost, basePath: string, existingOptions?: CompilerOptions, configFileName?: string, resolutionStack?: Path[], extraFileExtensions?: readonly FileExtensionInfo[], extendedConfigCache?: Map<ExtendedConfigCacheEntry>, existingWatchOptions?: WatchOptions): ParsedCommandLine {
    ...
    PerformanceDotting.start("parseJsonSourceFileConfigFileContent");
    ...
    PerformanceDotting.stop("parseJsonSourceFileConfigFileContent");
    tracing?.pop();
    return result;
}
