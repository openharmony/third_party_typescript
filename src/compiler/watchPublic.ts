...
import {
    ...
    createEmitAndSemanticDiagnosticsBuilderProgram, createEmitAndSemanticDiagnosticsBuilderProgramForArkTs,
    createGetCanonicalFileName, createResolutionCache, CreateSourceFileOptions, createWatchCompilerHostOfConfigFile,
    createWatchCompilerHostOfFilesAndCompilerOptions, createWatchFactory, Debug, Diagnostic, DiagnosticMessage,
    DiagnosticReporter, Diagnostics, DirectoryStructureHost, DirectoryWatcherCallback,
    EmitAndSemanticDiagnosticsBuilderProgram, ESMap, ExtendedConfigCacheEntry, FileExtensionInfo, FileReference,
    FileWatcher, FileWatcherCallback, FileWatcherEventKind, generateDjb2Hash, getBuildInfo,
    ...
    getTsBuildInfoEmitOutputFilePathForLinter, HasInvalidatedResolutions, isArray, isIgnoredFileFromWildCardWatching,
    isProgramUptoDate, Map, MapLike, maybeBind, ModuleResolutionCache, noop, noopFileWatcher,
    parseConfigHostFromCompilerHostLike, ParsedCommandLine, Path, perfLogger, PollingInterval, Program,
    ProjectReference, ResolutionCacheHost, ResolvedModule, ResolvedProjectReference, ResolvedTypeReferenceDirective,
    returnFalse, returnTrue, ScriptTarget, setGetSourceFileAsHashVersioned, SharedExtendedConfigFileWatcher, SourceFile,
    sys, System, toPath, updateErrorForNoInputFiles, updateMissingFilePathsWatch, updateSharedExtendedConfigFileWatcher,
...
export function createWatchProgram<T extends BuilderProgram>(host: WatchCompilerHostOfFilesAndCompilerOptions<T> & WatchCompilerHostOfConfigFile<T>): WatchOfFilesAndCompilerOptions<T> | WatchOfConfigFile<T> {
    ...
    function getVersionedSourceFileByPath(fileName: string, path: Path, languageVersionOrOptions: ScriptTarget | CreateSourceFileOptions, onError?: (message: string) => void, shouldCreateNewSourceFile?: boolean, _options?: CompilerOptions): SourceFile | undefined {
