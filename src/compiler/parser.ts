...
// Set language version: ArkTS 1.1、1.2
let languageVersionCallBack: ((filePath: string) => boolean) | undefined;
export function setLanguageVersionByFilePath(getLanguageVersion: ((filePath: string) => boolean) | undefined): void {
