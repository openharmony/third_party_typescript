...
import {
    ...
    forEachEmittedFile, forEachEntry, forEachKey, forEachRight, FunctionLikeDeclaration, getAllowJSCompilerOption,
    ...
    getEmitScriptTarget, getErrorSpanForNode, getEtsLibs, getExternalModuleName, getJSXImplicitImportBase,
    getJSXRuntimeImport, getLineAndCharacterOfPosition, getLineStarts, getMatchedFileSpec, getMatchedIncludeSpec,
    getModuleByPMType, getModulePathPartByPMType, getNewLineCharacter, getNormalizedAbsolutePath,
    getNormalizedAbsolutePathWithoutRoot, getNormalizedPathComponents, getOutputDeclarationFileName,
    getOutputPathsForBundle, getPackageScopeForPath, getPathFromPathComponents, getPositionOfLineAndCharacter,
    getPropertyArrayElementValue, getPropertyAssignment, getResolvedModule, getRootLength,
    getSetExternalModuleIndicator, getSpellingSuggestion, getStrictOptionValue, getSupportedExtensions,
    ...
    isInJSFile, isLiteralImportTypeNode, isModifier, isModuleDeclaration, isObjectLiteralExpression, isOhpm,
    isPlainJsFile, isRequireCall, isRootedDiskPath, isSourceFileJS, isString, isStringLiteral, isStringLiteralLike,
    isTraceEnabled, JsonSourceFile, JsxEmit, length, libMap, libs, Map, mapDefined, mapDefinedIterator, maybeBind,
    memoize, MemoryDotting, MethodDeclaration, ModifierFlags, ModifierLike, ModuleBlock, ModuleDeclaration, ModuleKind,
    ModuleResolutionCache, ModuleResolutionHost, moduleResolutionIsEqualTo, ModuleResolutionKind, Mutable, Node,
    NodeArray, NodeFlags, nodeModulesPathPart, NodeWithTypeArguments, noop, normalizePath, notImplementedResolver,
    noTransformers, ObjectLiteralExpression, ohModulesPathPart, OperationCanceledException, optionsHaveChanges, outFile,
    PackageId, packageIdToPackageName, packageIdToString, PackageJsonInfoCache, padLeft, ParameterDeclaration,
    ParseConfigFileHost, ParsedCommandLine, parseIsolatedEntityName, parseJsonSourceFileConfigFileContent, Path,
    pathIsAbsolute, pathIsRelative, PerformanceDotting, Program, ProjectReference, ProjectReferenceFile, projectReferenceIsEqualTo,
...
export function createProgram(rootNamesOrOptions: readonly string[] | CreateProgramOptions, _options?: CompilerOptions, _host?: CompilerHost, _oldProgram?: Program, _configFileParsingDiagnostics?: readonly Diagnostic[]): Program {
    ...
    const recordInfo = MemoryDotting.recordStage(MemoryDotting.BEFORE_PROGRAM);
