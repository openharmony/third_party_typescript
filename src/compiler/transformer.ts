import {
    ...
    Identifier, isBundle, isSourceFile, LexicalEnvironmentFlags, map, memoize, MemoryDotting, ModuleKind, Node, PerformanceDotting,
    NodeFactory, NodeFlags, noop, notImplemented, returnUndefined, ScriptTarget, setEmitFlags, some, SourceFile,
    Statement, SyntaxKind, tracing, TransformationContext, TransformationResult, transformClassFields,
    transformDeclarations, transformECMAScriptModule, Transformer, TransformerFactory, transformES2015, transformES2016,
    transformES2017, transformES2018, transformES2019, transformES2020, transformES2021, transformES5, transformESNext,
