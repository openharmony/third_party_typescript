import {
    __String, AccessExpression, AnnotationDeclaration, AnnotationPropertyDeclaration, addRelatedInfo, append, appendIfUnique, ArrayBindingElement, ArrayLiteralExpression,
    ...
    InternalSymbolName, isAliasableExpression, isAmbientModule, isAnnotationPropertyDeclaration, isAssignmentExpression, isAssignmentOperator,
    ...
    LiteralLikeElementAccessExpression, Map, MappedTypeNode, MemoryDotting, MethodDeclaration, ModifierFlags,
    ModuleBlock, ModuleDeclaration, Mutable, NamespaceExportDeclaration, Node, NodeArray, NodeFlags, nodeHasName,
    nodeIsMissing, nodeIsPresent, NonNullChain, NonNullExpression, NumericLiteral, objectAllocator,
    ObjectLiteralExpression, OptionalChain, ParameterDeclaration, ParenthesizedExpression, Pattern,
    PatternAmbientModule, perfLogger, PerformanceDotting, PostfixUnaryExpression, PrefixUnaryExpression, PrivateIdentifier,
    PropertyAccessChain, PropertyAccessExpression, PropertyDeclaration, PropertySignature, removeFileExtension,
    ReturnStatement, ScriptTarget, Set, SetAccessorDeclaration, setParent, setParentRecursive, setValueDeclaration,
    ShorthandPropertyAssignment, shouldPreserveConstEnums, SignatureDeclaration, skipParentheses, sliceAfter, some,
    SourceFile, SpreadElement, Statement, StringLiteral, SwitchStatement, Symbol, SymbolFlags, symbolName, SymbolTable,
...
function createBinder(): (file: SourceFile, options: CompilerOptions) => void {
    ...
    var parent: Node;
    var container: Node;
    var thisParentContainer: Node; // Container one level up
