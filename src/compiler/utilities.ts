...
import {
    ...
    affectsEmitOptionDeclarations, AllAccessorDeclarations, AmbientModuleDeclaration, AnnotationPropertyDeclaration, 
    AnyImportOrBareOrAccessedRequire, AnyImportOrReExport, AnyImportSyntax, AnyValidImportOrReExport, arrayFrom,
    ArrayLiteralExpression, ArrayTypeNode, ArrowFunction, AsExpression, AssertionExpression, assertType, AssignmentDeclarationKind,
    AssignmentExpression, AssignmentOperatorToken, BinaryExpression, binarySearch, BindableObjectDefinePropertyCall,
    ...
    EtsComponentExpression, every, ExportAssignment, ExportDeclaration, ExportSpecifier, Expression,
    ExpressionStatement, ExpressionWithTypeArguments, Extension, ExternalModuleReference, factory, FileExtensionInfo,
    fileExtensionIs, fileExtensionIsOneOf, FileReference, FileWatcher, filter, find, findAncestor, findBestPatternMatch,
    findIndex, findLast, firstDefined, firstOrUndefined, flatMap, flatMapToMutable, flatten, forEach,
    forEachAncestorDirectory, forEachChild, forEachChildRecursively, ForInOrOfStatement, ForInStatement, ForOfStatement,
    ForStatement, FunctionBody, FunctionDeclaration, FunctionExpression, FunctionLikeDeclaration,
    GetAccessorDeclaration, getAllDecorators, getBaseFileName, GetCanonicalFileName, getCombinedModifierFlags,
    getCombinedNodeFlags, getDirectoryPath, getEntries, getJSDocAugmentsTag, getJSDocDeprecatedTagNoCache,
    getJSDocImplementsTags, getJSDocOverrideTagNoCache, getJSDocParameterTags, getJSDocParameterTagsNoCache,
    getJSDocPrivateTagNoCache, getJSDocProtectedTagNoCache, getJSDocPublicTagNoCache, getJSDocReadonlyTagNoCache,
    getJSDocReturnType, getJSDocTags, getJSDocType, getJSDocTypeParameterTags, getJSDocTypeParameterTagsNoCache,
    getJSDocTypeTag, getLeadingCommentRanges, getLineAndCharacterOfPosition, getLinesBetweenPositions, getLineStarts,
    getModeForFileReference, getModeForResolutionAtIndex, getNameOfDeclaration, getNormalizedAbsolutePath,
    getNormalizedPathComponents, getOwnKeys, getParseTreeNode, getPathComponents, getPathFromPathComponents,
    getRelativePathToDirectoryOrUrl, getRootLength, getStringComparer, getSymbolId, getTrailingCommentRanges,
    HasExpressionInitializer, hasExtension, hasInitializer, HasInitializer, HasJSDoc, hasJSDocNodes, HasModifiers,
    hasProperty, HasType, HasTypeArguments, HeritageClause, Identifier, IdentifierTypePredicate, identity, idText,
    IfStatement, ignoredPaths, ImportCall, ImportClause, ImportDeclaration, ImportEqualsDeclaration, ImportMetaProperty,
    ImportSpecifier, ImportTypeNode, IndexInfo, indexOfAnyCharCode, InitializedVariableDeclaration, insertSorted,
    InterfaceDeclaration, isAccessor, isAnnotation, isAnyDirectorySeparator, isArkTsDecorator, isArray, isArrayLiteralExpression,
    isArrowFunction, isBigIntLiteral, isBinaryExpression, isBindingPattern, isCallExpression, isClassDeclaration,
    isClassElement, isClassExpression, isClassLike, isClassStaticBlockDeclaration, isCommaListExpression,
    isComputedPropertyName, isConstructorDeclaration, isDeclaration, isDecorator, isElementAccessExpression,
    isEnumDeclaration, isEnumMember, isEtsComponentExpression, isExportAssignment, isExportDeclaration,
    isExpressionStatement, isExpressionWithTypeArguments, isExternalModule, isExternalModuleReference,
    isFileProbablyExternalModule, isForStatement, isFunctionDeclaration, isFunctionExpression, isFunctionLike,
    isFunctionLikeDeclaration, isFunctionLikeOrClassStaticBlockDeclaration, isGetAccessorDeclaration, isHeritageClause,
    isIdentifier, isIdentifierText, isImportTypeNode, isInterfaceDeclaration, isJSDoc, isJSDocFunctionType,
    isJSDocLinkLike, isJSDocMemberName, isJSDocNameReference, isJSDocNode, isJSDocParameterTag, isJSDocPropertyLikeTag,
    isJSDocSignature, isJSDocTag, isJSDocTemplateTag, isJSDocTypeExpression, isJSDocTypeLiteral, isJSDocTypeTag,
    isJsxChild, isJsxFragment, isJsxOpeningLikeElement, isJsxText, isLeftHandSideExpression, isLineBreak,
    isLiteralTypeNode, isMemberName, isMetaProperty, isMethodDeclaration, isMethodOrAccessor, isModuleDeclaration,
    isNamedDeclaration, isNamespaceExport, isNamespaceExportDeclaration, isNamespaceImport,
    isNoSubstitutionTemplateLiteral, isNumericLiteral, isObjectLiteralExpression, isOmittedExpression, isParameter,
    isParameterPropertyDeclaration, isParenthesizedExpression, isParenthesizedTypeNode, isPrefixUnaryExpression,
    isPrivateIdentifier, isPropertyAccessExpression, isPropertyAssignment, isPropertyDeclaration, isPropertyName,
    isPropertySignature, isQualifiedName, isRootedDiskPath, isSendableFunctionOrType, isSetAccessorDeclaration,
    isShorthandPropertyAssignment, isSourceFile, isString, isStringLiteral, isStringLiteralLike, isStruct,
    isTypeAliasDeclaration, isTypeElement, isTypeLiteralNode, isTypeNode, isTypeReferenceNode, isVariableDeclaration,
    isVariableStatement, isVoidExpression, isWhiteSpaceLike, isWhiteSpaceSingleLine, JSDoc, JSDocCallbackTag,
    JSDocEnumTag, JSDocMemberName, JSDocParameterTag, JSDocSignature, JSDocTag, JSDocTemplateTag, JSDocTypedefTag,
    JsonSourceFile, JsxChild, JsxElement, JsxEmit, JsxFragment, JsxOpeningElement, JsxOpeningLikeElement,
    JsxSelfClosingElement, JsxTagNameExpression, KeywordSyntaxKind, LabeledStatement, LanguageVariant, last,
    lastOrUndefined, LateVisibilityPaintedStatement, length, LiteralImportTypeNode, LiteralLikeElementAccessExpression,
    LiteralLikeNode, LogicalOrCoalescingAssignmentOperator, map, Map, mapDefined, MapLike, MemberName,
    MethodDeclaration, ModeAwareCache, ModifierFlags, ModifierLike, ModuleBlock, ModuleDeclaration, ModuleDetectionKind,
    ModuleKind, ModuleResolutionKind, moduleResolutionOptionDeclarations, MultiMap, NamedDeclaration, NamedExports,
    NamedImports, NamedImportsOrExports, NamespaceExport, NamespaceImport, NewExpression, NewLineKind, Node, NodeArray,
    NodeFlags, NonNullExpression, noop, normalizePath, NoSubstitutionTemplateLiteral, NumericLiteral, ObjectFlags,
    ObjectFlagsType, ObjectLiteralElement, ObjectLiteralExpression, ObjectLiteralExpressionBase, ObjectTypeDeclaration,
    optionsAffectingProgramStructure, or, OuterExpressionKinds, PackageId, ParameterDeclaration,
    ParenthesizedExpression, ParenthesizedTypeNode, parseConfigFileTextToJson, PartiallyEmittedExpression, Path,
    pathIsRelative, Pattern, PostfixUnaryExpression, PrefixUnaryExpression, PrinterOptions, PrintHandlers,
    PrivateIdentifier, ProjectReference, PrologueDirective, PropertyAccessEntityNameExpression,
    PropertyAccessExpression, PropertyAssignment, PropertyDeclaration, PropertyName, PropertyNameLiteral, PseudoBigInt,
    QualifiedName, ReadonlyCollection, ReadonlyESMap, ReadonlyTextRange, removeTrailingDirectorySeparator,
    RequireOrImportCall, RequireVariableStatement, ResolvedModuleFull, ResolvedTypeReferenceDirective,
    resolveTripleslashReference, ReturnStatement, SatisfiesExpression, ScriptKind, ScriptTarget,
    ...
    StructDeclaration, SuperCall, SuperExpression, SuperProperty, SwitchStatement, Symbol, SymbolFlags, SymbolTable,
    SyntaxKind, SyntaxList, sys, TaggedTemplateExpression, TemplateLiteral, TemplateLiteralLikeNode,
    TemplateLiteralTypeSpan, TemplateSpan, TextRange, TextSpan, ThisTypePredicate, Token, TokenFlags, tokenToString,
    toPath, tracing, TransformFlags, TransientSymbol, trimString, trimStringStart, TriviaSyntaxKind, tryCast,
    tryRemovePrefix, TryStatement, TsConfigSourceFile, TupleTypeNode, Type, TypeAliasDeclaration, TypeAssertion,
    TypeChecker, TypeCheckerHost, TypeElement, TypeFlags, TypeLiteralNode, TypeNode, TypeNodeSyntaxKind, TypeParameter,
    TypeParameterDeclaration, TypePredicate, TypePredicateKind, TypeReferenceNode, unescapeLeadingUnderscores,
    UnionOrIntersectionTypeNode, ValidImportTypeNode, VariableDeclaration, VariableDeclarationInitializedTo,
    VariableDeclarationList, VariableLikeDeclaration, VariableStatement, version, WhileStatement, WithStatement,
    WriteFileCallback, WriteFileCallbackData, YieldExpression,
} from "./_namespaces/ts";
...
export function getTokenPosOfNode(node: Node, sourceFile?: SourceFileLike, includeJsDoc?: boolean): number {
    ...
    return node.virtual ? node.pos : skipTrivia((sourceFile || getSourceFileOfNode(node)).text, node.pos, /*stopAfterLineBreak*/ false,
...
/** @internal */
export function getContaningConstructorDeclaration(node?: Node): ConstructorDeclaration | undefined {
    return node ? findAncestor(node, isConstructorDeclaration): undefined;
}
/** @internal */
...
export function childIsDecorated(node: Node, parent?: Node): boolean {
    switch (node.kind) {
        ...
        case SyntaxKind.StructDeclaration:
            return some((node as StructDeclaration).members, m => nodeOrChildIsDecorated(m, node, parent!)); // TODO: GH#18217
        case SyntaxKind.MethodDeclaration:
        case SyntaxKind.SetAccessor:
        case SyntaxKind.Constructor:
...
export function getDeclarationEmitExtensionForPath(path: string) {
    return fileExtensionIsOneOf(path, [Extension.Mjs, Extension.Mts]) ? Extension.Dmts :
        ...
        fileExtensionIsOneOf(path, [Extension.Ets]) ? Extension.Dets : Extension.Dts;
}
...
/** @internal */
export function createSymlinkCache(cwd: string, getCanonicalFileName: GetCanonicalFileName, isOHModules?: boolean): SymlinkCache {
    ...
    return {
        ...
        setSymlinksFromResolutions(files, typeReferenceDirectives) {
            ...
            for (const file of files) {
                file.resolvedModules?.forEach(resolution => processResolution(this, resolution, isOHModules));
            }
            typeReferenceDirectives?.forEach(resolution => processResolution(this, resolution, isOHModules));
        },
        hasProcessedResolutions: () => hasProcessedResolutions,
    };

    function processResolution(cache: SymlinkCache, resolution: ResolvedModuleFull | ResolvedTypeReferenceDirective | undefined, isOHModules?: boolean) {
        ...
        const [commonResolved, commonOriginal] = guessDirectorySymlink(resolvedFileName, originalPath, cwd, getCanonicalFileName, isOHModules) || emptyArray;
...
function guessDirectorySymlink(a: string, b: string, cwd: string, getCanonicalFileName: GetCanonicalFileName, isOHModules?: boolean): [string, string] | undefined {
    ...
    while (
        ...
        !isNodeModulesOrScopedPackageDirectory(aParts[aParts.length - 2], getCanonicalFileName, isOHModules) &&
        !isNodeModulesOrScopedPackageDirectory(bParts[bParts.length - 2], getCanonicalFileName, isOHModules) &&
...
function isNodeModulesOrScopedPackageDirectory(s: string | undefined, getCanonicalFileName: GetCanonicalFileName, isOHModules?: boolean): boolean {
    return s !== undefined && (getCanonicalFileName(s) === "node_modules" || (isOHModules && getCanonicalFileName(s) === "oh_modules") || startsWith(s, "@"));
}
 ...
 * @internal
 */
export const supportedTSExtensions: readonly Extension[][] = [[Extension.Ts, Extension.Tsx, Extension.Dts, Extension.Ets, Extension.Dets], [Extension.Cts, Extension.Dcts], [Extension.Mts, Extension.Dmts]];
/** @internal */
...
const supportedTSExtensionsForExtractExtension: readonly Extension[] = [Extension.Dts, Extension.Dcts, Extension.Dmts, Extension.Dets, Extension.Cts, Extension.Mts, Extension.Ts, Extension.Tsx, Extension.Cts, Extension.Mts, Extension.Ets];
/** @internal */
...
const allSupportedExtensions: readonly Extension[][] = [[Extension.Ts, Extension.Tsx, Extension.Dts, Extension.Ets, Extension.Dets, Extension.Js, Extension.Jsx], [Extension.Cts, Extension.Dcts, Extension.Cjs], [Extension.Mts, Extension.Dmts, Extension.Mjs]];
const allSupportedExtensionsWithJson: readonly Extension[][] = [...allSupportedExtensions, [Extension.Json]];
/** @internal */
export const supportedDeclarationExtensions: readonly Extension[] = [Extension.Dts, Extension.Dcts, Extension.Dmts, Extension.Dets];
...
const extensionsToRemove = [Extension.Dts, Extension.Dets, Extension.Dmts, Extension.Dcts, Extension.Mjs, Extension.Mts, Extension.Cjs, Extension.Cts, Extension.Ts, Extension.Js, Extension.Tsx, Extension.Jsx, Extension.Json, Extension.Ets];
/** @internal */
...
export function extensionIsTS(ext: Extension): boolean {
    return ext === Extension.Ts || ext === Extension.Tsx || ext === Extension.Dts || ext === Extension.Cts || ext === Extension.Mts || ext === Extension.Dmts || ext === Extension.Dcts || ext === Extension.Ets || ext === Extension.Dets;
}
...
/** @internal */
export function getNodeModulePathParts(fullPath: string, modulePathPart: string): NodeModulePathParts | undefined {
    ...
    while (partEnd >= 0) {
        ...
        switch (state) {
            case States.BeforeNodeModules:
                if (fullPath.indexOf(modulePathPart, partStart) === partStart) {
