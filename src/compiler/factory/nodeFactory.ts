import {
    addRange, AnnotationDeclaration, AnnotationElement, AnnotationPropertyDeclaration, append, appendIfUnique, ArrayBindingElement,
    ArrayBindingPattern, ArrayLiteralExpression, ArrayTypeNode,
    ...
    ClassStaticBlockDeclaration, ColonToken, CommaListExpression, ComputedPropertyName, ConciseBody,
    ...
    EnumDeclaration, EnumMember, EqualsGreaterThanToken, escapeLeadingUnderscores, EtsComponentExpression, every,
    ExclamationToken, ExportAssignment, ExportDeclaration, ExportSpecifier, Expression, ExpressionStatement,
    ExpressionWithTypeArguments, ExternalModuleReference, FalseLiteral, FileReference, findUseStrictPrologue, forEach,
    ForInitializer, ForInStatement, formatGeneratedName, ForOfStatement, ForStatement, FunctionDeclaration,
    FunctionExpression, FunctionLikeDeclaration, FunctionTypeNode, GeneratedIdentifier, GeneratedIdentifierFlags,
    ...
    IntersectionTypeNode, isAnnotationDeclaration, isArray, isArrayLiteralExpression, isArrowFunction, isAssignmentPattern, isBinaryExpression,
    ...
    isStatementOrBlock, isString, isStringLiteral, isStructDeclaration, isSuperKeyword, isSuperProperty,
    isThisIdentifier, isTypeAliasDeclaration, isTypeParameterDeclaration, isVariableDeclaration, isVariableStatement,
    JSDoc, JSDocAllType, JSDocAugmentsTag, JSDocAuthorTag, JSDocCallbackTag, JSDocClassTag, JSDocComment,
    JSDocDeprecatedTag, JSDocEnumTag, JSDocFunctionType, JSDocImplementsTag, JSDocLink, JSDocLinkCode, JSDocLinkPlain,
    JSDocMemberName, JSDocNamepathType, JSDocNameReference, JSDocNamespaceDeclaration, JSDocNonNullableType,
    JSDocNullableType, JSDocOptionalType, JSDocOverrideTag, JSDocParameterTag, JSDocPrivateTag, JSDocPropertyLikeTag,
    JSDocPropertyTag, JSDocProtectedTag, JSDocPublicTag, JSDocReadonlyTag, JSDocReturnTag, JSDocSeeTag, JSDocSignature,
    JSDocTag, JSDocTemplateTag, JSDocText, JSDocThisTag, JSDocType, JSDocTypedefTag, JSDocTypeExpression,
    JSDocTypeLiteral, JSDocTypeTag, JSDocUnknownTag, JSDocUnknownType, JSDocVariadicType, JsxAttribute,
    JsxAttributeLike, JsxAttributes, JsxAttributeValue, JsxChild, JsxClosingElement, JsxClosingFragment, JsxElement,
    JsxExpression, JsxFragment, JsxOpeningElement, JsxOpeningFragment, JsxSelfClosingElement, JsxSpreadAttribute,
    JsxTagNameExpression, JsxText, KeywordSyntaxKind, KeywordToken, KeywordTypeNode, KeywordTypeSyntaxKind,
    LabeledStatement, LanguageVariant, lastOrUndefined, LeftHandSideExpression, LiteralToken, LiteralTypeNode, map, Map,
    MappedTypeNode, memoize, memoizeOne, MergeDeclarationMarker, MetaProperty, MethodDeclaration,
    MethodSignature, MinusToken, MissingDeclaration, Modifier, ModifierFlags, ModifierLike, modifiersToFlags,
    ModifierSyntaxKind, ModifierToken, ModuleBlock, ModuleBody, ModuleDeclaration, ModuleKind, ModuleName,
    ModuleReference, Mutable, MutableNodeArray, NamedDeclaration, NamedExportBindings, NamedExports,
    NamedImportBindings, NamedImports, NamedTupleMember, NamespaceExport, NamespaceExportDeclaration, NamespaceImport,
    NewExpression, Node, NodeArray, NodeFactory, NodeFlags, nodeIsSynthesized, NonNullChain, NonNullExpression,
    NoSubstitutionTemplateLiteral, NotEmittedStatement, NullLiteral, nullNodeConverters, nullParenthesizerRules,
    NumericLiteral, objectAllocator, ObjectBindingPattern, ObjectLiteralElementLike, ObjectLiteralExpression,
    OmittedExpression, OptionalTypeNode, OuterExpression, OuterExpressionKinds, ParameterDeclaration,
    ParenthesizedExpression, ParenthesizedTypeNode, parseNodeFactory, PartiallyEmittedExpression, PlusToken,
    PostfixUnaryExpression, PostfixUnaryOperator, PrefixUnaryExpression, PrefixUnaryOperator, PrimaryExpression,
    PrivateIdentifier, PrologueDirective, PropertyAccessChain, PropertyAccessExpression, PropertyAssignment,
    PropertyDeclaration, PropertyDescriptorAttributes, PropertyName, PropertyNameLiteral, PropertySignature,
    PseudoBigInt, pseudoBigIntToString, PunctuationSyntaxKind, PunctuationToken, Push, QualifiedName, QuestionDotToken,
    QuestionToken, ReadonlyKeyword, reduceLeft, RegularExpressionLiteral, RestTypeNode, ReturnStatement, returnTrue,
    sameFlatMap, SatisfiesExpression, Scanner, ScriptTarget, SemicolonClassElement, SetAccessorDeclaration,
    setEachParent, setEmitFlags, setParent, setTextRange, setTextRangePosEnd, setTextRangePosWidth,
    ShorthandPropertyAssignment, SignatureDeclarationBase, singleOrUndefined, skipOuterExpressions, skipParentheses,
    some, SourceFile, SourceMapSource, SpreadAssignment, SpreadElement, startOnNewLine, startsWith, Statement,
    StringLiteral, StringLiteralLike, stringToToken, StructDeclaration, SuperExpression, SwitchStatement, SyntaxKind,
    SyntaxList, SyntheticExpression, SyntheticReferenceExpression, TaggedTemplateExpression, TemplateExpression,
    TemplateHead, TemplateLiteral, TemplateLiteralLikeNode, TemplateLiteralToken, TemplateLiteralTypeNode,
    TemplateLiteralTypeSpan, TemplateMiddle, TemplateSpan, TemplateTail, TextRange, ThisExpression, ThisTypeNode,
    ThrowStatement, Token, TokenFlags, TransformFlags, TrueLiteral, TryStatement, TupleTypeNode, Type,
    TypeAliasDeclaration, TypeAssertion, TypeElement, TypeLiteralNode, TypeNode, TypeOfExpression, TypeOfTag,
    TypeOperatorNode, TypeParameterDeclaration, TypePredicateNode, TypeQueryNode, TypeReferenceNode,
    UnionOrIntersectionTypeNode, UnionTypeNode, UnparsedNode, UnparsedPrepend, UnparsedPrologue, UnparsedSource,
    UnparsedSourceText, UnparsedSyntheticReference, UnparsedTextLike, UnscopedEmitHelper, VariableDeclaration,
    VariableDeclarationList, VariableStatement, visitNode, VisitResult, VoidExpression, WhileStatement, WithStatement,
    YieldExpression,
} from "../_namespaces/ts";
...
export function createNodeFactory(flags: NodeFactoryFlags, baseFactory: BaseNodeFactory): NodeFactory {
    ...
    const factory: NodeFactory = {
        ...
        createPropertyAccessExpression: flags & NodeFactoryFlags.NoIndentationOnFreshPropertyAccess ?
            (expression: Expression, name: string) => setEmitFlags(createPropertyAccessExpression(expression, name), EmitFlags.NoIndentation) :
            createPropertyAccessExpression,
        updatePropertyAccessExpression,
        createPropertyAccessChain: flags & NodeFactoryFlags.NoIndentationOnFreshPropertyAccess ?
        (expression: Expression, questionDotToken: QuestionDotToken | undefined, name: string) => setEmitFlags(createPropertyAccessChain(expression, questionDotToken, name), EmitFlags.NoIndentation) :
    ...
    function updateStructDeclaration(
        ...
        members: readonly ClassElement[]
         ...
         return node.modifiers !== modifiers
            ...
            || node.heritageClauses !== heritageClauses
            || node.members !== members
            ? update(createStructDeclaration(modifiers, name, typeParameters, heritageClauses, members), node)
            : node;
    }
