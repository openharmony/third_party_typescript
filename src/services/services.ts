...
import {
    ...
    createIncrementalProgramForArkTs,
    createMultiMap,
    createProgram,
...
export function createLanguageService(
    ...
    // Set the callback to determine languageVersion by filePath (will used in parsing)
    setLanguageVersionByFilePath(host.isStaticSourceFile);
