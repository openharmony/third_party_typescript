...
import {
    ...
    BinaryExpression, BreakpointResolver, BuilderProgram, CallHierarchy, CallHierarchyIncomingCall, CallHierarchyItem,
    ...
    computeSuggestionDiagnostics, createDocumentRegistry, createGetCanonicalFileName, createIncrementalProgram,
    createIncrementalProgramForArkTs, createMultiMap, createProgram, CreateProgramOptions, createSourceFile,
    CreateSourceFileOptions, createTextSpanFromBounds, createTextSpanFromNode, createTextSpanFromRange, Debug,
    Declaration, deduplicate, DefinitionInfo, DefinitionInfoAndBoundSpan, Diagnostic, DiagnosticWithLocation,
    directoryProbablyExists, DocCommentTemplateOptions, DocumentHighlights, DocumentRegistry, DocumentSpan,
    EditorOptions, EditorSettings, ElementAccessExpression, EmitTextWriter, emptyArray, emptyOptions, EndOfFileToken,
    EntityName, equateValues, ESMap, ExportDeclaration, FileReference, FileTextChanges, filter, find, FindAllReferences,
    findChildOfKind, findPrecedingToken, first, firstDefined, firstOrOnly, flatMap, forEach, forEachChild,
    ...
    getSourceMapper, getTokenPosOfNode, getTouchingPropertyName, getTouchingToken, GoToDefinition,
    HasInvalidatedResolutions, hasJSDocNodes, hasProperty, hasStaticModifier, hasSyntacticModifier, HighlightSpanKind,
    HostCancellationToken, hostGetCanonicalFileName, hostUsesCaseSensitiveFileNames, Identifier, identity, idText,
    ImplementationLocation, ImportDeclaration, IndexKind, IndexType, InlayHint, InlayHints, InlayHintsContext,
    insertSorted, InterfaceType, IntersectionType, isArray, isBindingPattern, isComputedPropertyName,
    isConstTypeReference, IScriptSnapshot, isDeclarationName, isGetAccessor, isIdentifier, isImportMeta, isInComment,
    isIncrementalCompilation, isInMarkedKitImport, isInsideJsxElement, isInsideJsxElementOrAttribute, isInString, isInTemplateString,
    isIntrinsicJsxName, isJSDocCommentContainingNode, isJsxAttributes, isJsxClosingElement, isJsxElement, isJsxFragment,
    isJsxOpeningElement, isJsxOpeningFragment, isJsxText, isLabelName, isLiteralComputedPropertyDeclarationName,
    isNamedExports, isNamedTupleMember, isNameOfModuleDeclaration, isNewExpression, isNodeKind, isObjectLiteralElement,
    isObjectLiteralExpression, isPrivateIdentifier, isProgramUptoDate, isPropertyAccessExpression, isPropertyName,
    isRightSideOfPropertyAccess, isRightSideOfQualifiedName, isSetAccessor, isSourceFile, isStringOrNumericLiteralLike, isTagName,
    isTextWhiteSpaceLike, isThisTypeParameter, JsDoc, JSDoc, JSDocContainer, JSDocTagInfo, JsonSourceFile,
    JsxAttributes, JsxClosingTagInfo, JsxElement, JsxEmit, JsxFragment, LanguageService, LanguageServiceHost,
    LanguageServiceMode, LanguageVariant, lastOrUndefined, length, LineAndCharacter, lineBreakPart, LiteralType, map,
    Map, mapDefined, MapLike, mapOneOrMany, maybeBind, maybeSetLocalizedDiagnosticMessages, ModeAwareCache,
    ModifierFlags, ModuleDeclaration, NavigateToItem, NavigationBarItem, NavigationTree, Node, NodeArray, NodeFlags,
    noop, normalizePath, NumberLiteralType, NumericLiteral, ObjectAllocator, ObjectFlags, ObjectLiteralElement,
    ObjectLiteralExpression, OperationCanceledException, OrganizeImports, OrganizeImportsArgs, OrganizeImportsMode,
    OutliningElementsCollector, OutliningSpan, ParseConfigFileHost, ParsedCommandLine,
    parseJsonSourceFileConfigFileContent, Path, PerformanceDotting, positionIsSynthesized, PossibleProgramFileInfo, PragmaMap,
    PrivateIdentifier, Program, PropertyName, Push, QuickInfo, refactor, RefactorContext, RefactorEditInfo,
    RefactorTriggerReason, ReferencedSymbol, ReferenceEntry, Rename, RenameInfo, RenameInfoOptions, RenameLocation,
    ResolvedModuleFull, ResolvedProjectReference, ResolvedTypeReferenceDirective, returnFalse, scanner,
    ScriptElementKind, ScriptElementKindModifier, ScriptKind, ScriptTarget, SelectionRange,
    SemanticClassificationFormat, Set, setObjectAllocator, Signature, SignatureDeclaration, SignatureFlags,
    SignatureHelp, SignatureHelpItems, SignatureHelpItemsOptions, SignatureKind, singleElementArray,
    SmartSelectionRange, SortedArray, SourceFile, SourceFileLike, SourceMapSource, Statement, stringContains,
    StringLiteral, StringLiteralLike, StringLiteralType, Symbol, SymbolDisplay, SymbolDisplayPart, SymbolFlags,
    symbolName, SyntaxKind, SyntaxList, tagNamesAreEquivalent, TextChange, TextChangeRange, TextInsertion, TextRange,
    TextSpan, textSpanEnd, timestamp, TodoComment, TodoCommentDescriptor, Token, toPath, tracing, TransformFlags,
