import {
    __String, addEmitFlags, addSyntheticLeadingComment, addSyntheticTrailingComment, AnyImportOrRequireStatement,
    assertType, AssignmentDeclarationKind, BinaryExpression, binarySearchKey, BindingElement, BreakOrContinueStatement,
    CallExpression, canHaveModifiers, CaseClause, cast, CatchClause, CharacterCodes, ClassDeclaration, ClassExpression,
    clone, codefix, combinePaths, CommentKind, CommentRange, compareTextSpans, compareValues, Comparison,
    CompilerOptions, ConditionalExpression, contains, createPrinterWithRemoveCommentsOmitTrailingSemicolon, createRange, createScanner, createTextSpan,
    createTextSpanFromBounds, Debug, Declaration, Decorator, defaultMaximumTruncationLength, DeleteExpression,
    Diagnostic, DiagnosticMessage, DiagnosticWithLocation, directoryProbablyExists, DisplayPartsSymbolWriter,
    displayPartsToString, DocumentPosition, DocumentSpan, DoStatement, ElementAccessExpression, EmitFlags, EmitHint,
    emptyArray, EndOfFileToken, ensureScriptKind, EqualityOperator, escapeString, EtsComponentExpression,
    ExportAssignment, ExportDeclaration, Expression, ExpressionStatement, factory, FileTextChanges, filter, find,
    findAncestor, findConfigFile, first, firstDefined, firstOrUndefined, forEachAncestorDirectory, forEachChild,
    forEachLeadingCommentRange, forEachTrailingCommentRange, FormatCodeSettings, formatStringFromArgs, formatting,
    FormattingHost, ForOfStatement, FunctionDeclaration, FunctionExpression, FunctionLikeDeclaration,
    getAssignmentDeclarationKind, getCombinedNodeFlagsAlwaysIncludeJSDoc, getDirectoryPath, getEmitScriptTarget,
    getExternalModuleImportEqualsDeclarationExpression, getIndentString, getJSDocEnumTag, getLastChild,
    getLineAndCharacterOfPosition, getLineStarts, getLocaleSpecificMessage, getModuleByPMType, getModuleInstanceState,
    getNameOfDeclaration, getNodeId, getPackageJsonByPMType, getPackageNameFromTypesPackageName, getPathComponents,
    getRootDeclaration, getSourceFileOfNode, getSpanOfTokenAtPosition, getSymbolId, getTextOfIdentifierOrLiteral,
    getTextOfJSDocComment, getTextOfNode, getTypesPackageName, hasSyntacticModifier, HeritageClause, Identifier,
    identifierIsThisKeyword, identity, idText, IfStatement, ImportClause, ImportDeclaration, ImportSpecifier,
    ImportTypeNode, indexOfNode, IndexSignatureDeclaration, InternalSymbolName, isAmbientModule, isAnyImportSyntax,
    isArray, isArrayBindingPattern, isArrayTypeNode, isAsExpression, isAwaitExpression, isBinaryExpression,
    isBindingElement, isBreakOrContinueStatement, isCallExpression, isCallOrNewExpression, isClassDeclaration,
    isClassExpression, isClassStaticBlockDeclaration, isConditionalTypeNode, IScriptSnapshot, isDeclaration,
    isDeclarationName, isDecorator, isDeleteExpression, isElementAccessExpression, isEntityName, isEnumDeclaration,
    isExportAssignment, isExportDeclaration, isExportSpecifier, isExpression, isExpressionNode, isExternalModule,
    isExternalModuleImportEqualsDeclaration, isExternalModuleReference, isFileLevelUniqueName, isForInStatement,
    isForOfStatement, isFunctionBlock, isFunctionDeclaration, isFunctionExpression, isFunctionLike,
    isGetAccessorDeclaration, isGlobalScopeAugmentation, isHeritageClause, isIdentifier, isImportCall, isImportClause,
    isImportDeclaration, isImportEqualsDeclaration, isImportOrExportSpecifier, isImportSpecifier, isInferTypeNode,
    isInJSFile, isInterfaceDeclaration, isInternalModuleImportEqualsDeclaration, isJSDoc, isJSDocCommentContainingNode,
    isJSDocLink, isJSDocLinkCode, isJSDocLinkLike, isJSDocMemberName, isJSDocNameReference, isJSDocTag,
    isJSDocTemplateTag, isJSDocTypeAlias, isJsxElement, isJsxExpression, isJsxOpeningLikeElement, isJsxText, isKeyword,
    isLabeledStatement, isLet, isLiteralTypeNode, isMappedTypeNode, isModifier, isModuleBlock, isModuleDeclaration,
    isNamedDeclaration, isNamedExports, isNamedImports, isNamespaceExport, isNamespaceImport, isNewExpression,
    isNumericLiteral, isObjectBindingPattern, isObjectLiteralExpression, isOptionalChain, isOptionalChainRoot,
    isParameter, isPartOfTypeNode, isPrivateIdentifier, isPropertyAccessExpression, isPropertyNameLiteral,
    isQualifiedName, isRequireCall, isRequireVariableStatement, isRightSideOfQualifiedNameOrPropertyAccess,
    isRootedDiskPath, isSetAccessorDeclaration, isSourceFile, isSourceFileJS, isStringDoubleQuoted, isStringLiteral,
    isStringLiteralLike, isStringOrNumericLiteralLike, isStringTextContainingNode, isStructDeclaration, isSyntaxList,
    isTaggedTemplateExpression, isTemplateLiteralKind, isToken, isTypeAliasDeclaration, isTypeElement, isTypeNode,
    isTypeOfExpression, isTypeOperatorNode, isTypeParameterDeclaration, isTypeReferenceNode, isVarConst,
    isVariableDeclarationList, isVoidExpression, isWhiteSpaceLike, isWhiteSpaceSingleLine, isYieldExpression,
    IterationStatement, JSDocLink, JSDocLinkCode, JSDocLinkDisplayPart, JSDocLinkPlain, JSDocTagInfo, JSDocTypedefTag,
    JsTyping, JsxEmit, JsxOpeningLikeElement, LabeledStatement, LanguageServiceHost, last, lastOrUndefined,
    LiteralExpression, map, Map, maybeBind, Modifier, ModifierFlags, ModuleDeclaration, ModuleInstanceState,
    ModuleResolutionKind, ModuleSpecifierResolutionHost, moduleSpecifiers, Mutable, NewExpression, NewLineKind, Node,
    NodeArray, NodeBuilderFlags, NodeFlags, nodeIsMissing, nodeIsPresent, nodeIsSynthesized, noop, normalizePath,
    NoSubstitutionTemplateLiteral, notImplemented, nullTransformationContext, NumericLiteral, or, OrganizeImports,
    PackageJsonDependencyGroup, pathIsRelative, PrefixUnaryExpression, Program, ProjectPackageJsonInfo,
    PropertyAccessExpression, PropertyAssignment, PropertyName, QualifiedName, RefactorContext, Scanner,
    ScriptElementKind, ScriptElementKindModifier, ScriptKind, ScriptTarget, SemicolonPreference, setConfigFileInOptions,
    setOriginalNode, setTextRange, Signature, SignatureDeclaration, singleOrUndefined, skipAlias, skipOuterExpressions,
    some, SourceFile, SourceFileLike, SourceMapper, SpreadElement, stableSort, startsWith, stringContains,
    StringLiteral, StringLiteralLike, stringToToken, stripQuotes, StructDeclaration, Symbol, SymbolAccessibility,
    SymbolDisplay, SymbolDisplayPart, SymbolDisplayPartKind, SymbolFlags, SymbolFormatFlags, SymbolTracker, SyntaxKind,
    SyntaxList, TaggedTemplateExpression, TemplateExpression, TemplateLiteralToken, TemplateSpan, TextChange,
    textChanges, TextRange, TextSpan, textSpanContainsPosition, textSpanContainsTextSpan, textSpanEnd, Token,
    tokenToString, TransientSymbol, tryCast, Type, TypeChecker, TypeFormatFlags, TypeNode, TypeOfExpression,
    TypeQueryNode, unescapeLeadingUnderscores, UserPreferences, VariableDeclaration, visitEachChild, VoidExpression,
    YieldExpression,
} from "./_namespaces/ts";
...
function isPropertyAccessNamespaceReference(node: Node): boolean {
    ...
    if (!isLastClause && root.parent.kind === SyntaxKind.ExpressionWithTypeArguments && root.parent.parent.kind === SyntaxKind.HeritageClause) {
        ...
        return ((decl.kind === SyntaxKind.ClassDeclaration || decl.kind === SyntaxKind.StructDeclaration) && (root.parent.parent as HeritageClause).token === SyntaxKind.ImplementsKeyword) ||
...
/** @internal */
export function getDeclarationFromSymbol(symbol: Symbol | undefined, position = "first"): Declaration | undefined {
    return symbol?.valueDeclaration ?? (symbol?.declarations && symbol.declarations.length ? position === "first" ? first(symbol.declarations) : last(symbol.declarations) : undefined);
}
...
export function isVirtualAttributeTypeArgument(node: CallExpression | EtsComponentExpression): boolean {
    return node.typeArguments ?
        some(node.typeArguments,
            ...
            !!argument.typeName.escapedText.toString().match("Attribute")
        ) : true;
}

/** @internal */
export function getTextOfJSDocTagInfo(tag: JSDocTagInfo): string {
    if (!tag.text) {
        return "";
    }
    if (Array.isArray(tag.text)) {
        ...
        return getTextOfJSDocComment(tag.text) ?? "";
    }
}
