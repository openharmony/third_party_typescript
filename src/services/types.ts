import {
    BuilderProgram, CancellationToken, CompilerHost, CompilerOptions, ConditionCheckResult, CustomTransformers,
    Diagnostic, DiagnosticWithLocation, DocumentHighlights, DocumentPositionMapper, EmitOutput, ESMap, ExportInfoMap,
    FileCheckModuleInfo, FileReference, GetEffectiveTypeRootsHost, HasChangedAutomaticTypeDirectiveNames,
    HasInvalidatedResolutions, JsDocNodeCheckConfig, JsDocTagInfo, LineAndCharacter, MinimalResolutionCacheHost,
