import {
    __String, addToSeen, append, BinaryExpression, BreakOrContinueStatement, CallExpression, CancellationToken, cast,
    CharacterCodes, ClassElement, CodeAction, codefix, compareNumberOfDirectorySeparators,
    compareStringsCaseSensitiveUI, compareTextSpans, Comparison, CompilerOptions, compilerOptionsIndicateEsModules,
    CompletionEntry, CompletionEntryData, CompletionEntryDataAutoImport, CompletionEntryDataResolved,
    CompletionEntryDataUnresolved, CompletionEntryDetails, CompletionEntryLabelDetails, CompletionInfo,
    CompletionInfoFlags, CompletionsTriggerCharacter, CompletionTriggerKind, concatenate, ConstructorDeclaration,
    ContextFlags, createModuleSpecifierResolutionHost, createPackageJsonImportFilter, createPrinter, createSortedArray,
    createTextRangeFromSpan, createTextSpanFromBounds, createTextSpanFromNode, createTextSpanFromRange, Debug,
    Declaration, Diagnostics, diagnosticToString, displayPart, EmitHint, EmitTextWriter, escapeSnippetText,
    EtsComponentExpression, every, ExportKind, Expression, factory, filter, find, findAncestor, findChildOfKind,
    findPrecedingToken, first, firstDefined, flatMap, formatting, FunctionLikeDeclaration, getAllDecorators,
    getAllSuperTypeNodes, getAncestor, getCombinedLocalAndExportSymbolFlags, getContainingClass, getContainingStruct,
    getContaningConstructorDeclaration, getContextualTypeFromParent, getDeclarationFromSymbol,
    getDeclarationModifierFlagsFromSymbol, getEffectiveBaseTypeNode, getEffectiveModifierFlags,
    getEffectiveTypeAnnotationNode, getEmitModuleResolutionKind, getEmitScriptTarget,
    getEscapedTextOfIdentifierOrLiteral, getEtsComponentExpressionInnerExpressionStatementNode,
    getEtsExtendDecoratorsComponentNames, getEtsStylesDecoratorComponentNames, getExportInfoMap,
    getFormatCodeSettingsForWriting, getLanguageVariant, getLeftmostAccessExpression, getLineAndCharacterOfPosition,
    getLineStartPositionForPosition, getLocalSymbolForExportDefault, getNameForExportedSymbol, getNameOfDeclaration,
    getNameTable, getNewLineCharacter, getNewLineKind, getPropertyNameForPropertyNameNode, getQuotePreference,
    getReplacementSpanForContextToken, getRootDeclaration, getRootEtsComponentInnerCallExpressionNode,
    getSourceFileOfModule, getSourceFileOfNode, getSwitchedType, getSymbolId, getSynthesizedDeepClone,
    getTokenAtPosition, getTouchingPropertyName, hasDocComment, hasEffectiveModifier, hasInitializer, hasType,
    Identifier, ImportDeclaration, ImportEqualsDeclaration, ImportKind, ImportOrExportSpecifier, ImportSpecifier,
    ImportTypeNode, IncompleteCompletionsCache, insertSorted, InternalSymbolName, isAbstractConstructorSymbol,
    isArrowFunction, isAssertionExpression, isBigIntLiteral, isBinaryExpression, isBindingElement, isBindingPattern,
    isBreakOrContinueStatement, isCallExpression, isCaseClause, isCheckJsEnabledForFile, isClassElement, isClassLike,
    isClassMemberModifier, isClassOrTypeElement, isClassStaticBlockDeclaration, isComputedPropertyName,
    isConstructorDeclaration, isContextualKeyword, isDeclarationName, isDeprecatedDeclaration, isEntityName,
    isEqualityOperatorKind, isEtsComponentExpression, isExportAssignment, isExportDeclaration, isExpression,
    isExternalModuleNameRelative, isExternalModuleReference, isExternalModuleSymbol, isFunctionBlock, isFunctionLike,
    isFunctionLikeDeclaration, isFunctionLikeKind, isFunctionTypeNode, isIdentifier, isIdentifierText, isImportableFile,
    isImportDeclaration, isImportEqualsDeclaration, isImportKeyword, isImportSpecifier, isInComment,
    isInitializedProperty, isInJSFile, isInRightSideOfInternalImportEqualsDeclaration, isInString,
    isIntersectionTypeNode, isJSDoc, isJSDocParameterTag, isJSDocTag, isJSDocTemplateTag, isJsxAttribute,
    isJsxClosingElement, isJsxElement, isJsxExpression, isJsxFragment, isJsxOpeningLikeElement, isJsxSpreadAttribute,
    isKeyword, isKnownSymbol, isLabeledStatement, isLiteralImportTypeNode, isMemberName, isMethodDeclaration,
    isModifier, isModifierKind, isModuleDeclaration, isNamedExports, isNamedImports, isNamedImportsOrExports,
    isNamespaceImport, isObjectBindingPattern, isObjectLiteralExpression, isObjectTypeDeclaration, isParameter,
    isParameterPropertyModifier, isPartOfTypeNode, isPossiblyTypeArgumentPosition, isPrivateIdentifier,
    isPrivateIdentifierClassElementDeclaration, isPropertyAccessExpression, isPropertyDeclaration,
    isPropertyNameLiteral, isRegularExpressionLiteral, isShorthandPropertyAssignment, isSingleOrDoubleQuote,
    isSourceFile, isSourceFileJS, isSpreadAssignment, isStatement, isStatic, isString, isStringANonContextualKeyword,
    isStringLiteralLike, isStringLiteralOrTemplate, isStringTextContainingNode, isStructDeclaration, isSyntaxList,
    isTypeKeyword, isTypeKeywordTokenOrIdentifier, isTypeLiteralNode, isTypeNode, isTypeOfExpression,
    isTypeOnlyImportOrExportDeclaration, isTypeReferenceType, isValidTypeOnlyAliasUseSite, isVariableDeclaration,
    isVariableDeclarationList, isVariableLike, isVariableStatement, isVirtualAttributeTypeArgument, JsDoc,
    JSDocParameterTag, JSDocPropertyTag, JSDocReturnTag, JSDocTag, JSDocTagInfo, JSDocTemplateTag, JSDocTypedefTag,
    JSDocTypeExpression, JSDocTypeTag, JsTyping, JsxAttribute, JsxAttributes, JsxClosingElement, JsxElement,
    JsxOpeningLikeElement, JsxSpreadAttribute, LanguageServiceHost, LanguageVariant, last, lastOrUndefined, length,
    ListFormat, Map, mapDefined, maybeBind, MemberOverrideStatus, memoize, memoizeOne, MethodDeclaration, ModifierFlags,
    modifiersToFlags, ModifierSyntaxKind, modifierToFlag, ModuleDeclaration, ModuleReference,
    moduleResolutionRespectsExports, NamedImportBindings, Node, NodeArray, NodeBuilderFlags, NodeFlags, nodeIsMissing,
    ObjectBindingPattern, ObjectLiteralExpression, ObjectType, ObjectTypeDeclaration, or, positionBelongsToNode,
    positionIsASICandidate, positionsAreOnSameLine, PrinterOptions, probablyUsesSemicolons, Program,
    programContainsModules, PropertyAccessExpression, PropertyDeclaration, PropertyName, PseudoBigInt,
    pseudoBigIntToString, QualifiedName, quote, QuotePreference, rangeContainsPosition, rangeContainsPositionExclusive,
    rangeIsOnSingleLine, ScriptElementKind, ScriptElementKindModifier, ScriptKind, ScriptTarget, SemanticMeaning, Set,
    setSnippetElement, shouldUseUriStyleNodeCoreModules, SignatureHelp, SignatureKind, singleElementArray, skipAlias,
    SnippetKind, some, SortedArray, SourceFile, SpreadAssignment, stableSort, startsWith, stringToToken, stripQuotes,
    Symbol, SymbolDisplay, SymbolDisplayPart, SymbolDisplayPartKind, SymbolExportInfo, SymbolFlags, SymbolId,
    SyntaxKind, sys, TextChange, textChanges, textPart, TextRange, TextSpan, timestamp, Token, TokenSyntaxKind,
    tokenToString, tryCast, tryGetImportFromModuleSpecifier, Type, TypeChecker, TypeElement, TypeFlags,
    typeHasCallOrConstructSignatures, TypeLiteralNode, TypeOnlyAliasDeclaration, UnderscoreEscapedMap,
    unescapeLeadingUnderscores, UnionReduction, UnionType, UserPreferences, VariableDeclaration,
...
export function getCompletionEntriesFromSymbols(
    ...
    for (let i = 0; i < symbols.length; i++) {
        ...
        if (symbol.declarations && i < 50) {
            ...
            const container = getContaningConstructorDeclaration(symbol.valueDeclaration);
            const regex = /(Missing)/g;
            entry.displayParts = container && container.virtual ? symbolDisplayPartsDocumentationAndSymbolKind.displayParts.map(part => {
                if (part.text.match(regex)) {
                    part.text = part.text.replace(regex, entry.name);
                }
                return part;
            }) : symbolDisplayPartsDocumentationAndSymbolKind.displayParts;
        }
...
function getCompletionData(
            ...
            switch (parent.kind) {
                case SyntaxKind.PropertyAccessExpression:
                    ...
                    if (nodeIsMissing(leftmostAccessExpression) ||
                        ((isCallExpression(node) || isFunctionLike(node) || isEtsComponentExpression(node)) &&
    ...
    function addTypeProperties(type: Type, insertAwait: boolean, insertQuestionDot: boolean): void {
        ...
        if (inCheckedFile) {
            ...
            if (typeSymbols.length) {
                ...
                if (etsComponentExpressionNode && shouldAddExtendOrStylesProperties(node, returnType)) {
    ...
    function shouldAddExtendOrStylesProperties(node: Node, returnType: Type) {
        return isCallExpressionOrEtsComponentExpressionKind(node, returnType) &&
            !!returnType.symbol.declarations?.length &&
            !isStructDeclaration(returnType.symbol.declarations[0]);
    }

    function isCallExpressionOrEtsComponentExpressionKind(node: Node, returnType: Type):boolean {
        if ((isCallExpression(node) || isEtsComponentExpression(node)) && returnType.symbol) {
            return !!returnType.symbol.getName().match("Attribute") && isVirtualAttributeTypeArgument(node);
        }
        return !!node.virtual && isIdentifier(node) && !!node.escapedText.toString().match("Instance");
    }
    ...
    function addEtsExtendPropertySymbol(node: EtsComponentExpression | CallExpression | PropertyAccessExpression | Identifier, insertQuestionDot: boolean) {
        const locals = getSourceFileOfNode(node).locals;
        if (!locals) {
            return;
        }
        const etsComponentName = isIdentifier(node) ? node.escapedText : isIdentifier(node.expression) ? node.expression.escapedText : undefined;
        const extendComponentSymbolMap: UnderscoreEscapedMap<Symbol[]> = new Map<__String, Symbol[]>();
        locals.forEach(local => {
            const declaration = getDeclarationFromSymbol(local);
            if (!declaration) {
                return;
            }
            const currDeclaration = isVariableDeclaration(declaration) && isVariableDeclarationList(declaration.parent) && isVariableStatement(declaration.parent.parent) ? declaration.parent.parent : declaration;
            getEtsExtendDecoratorsComponentNames(getAllDecorators(currDeclaration), compilerOptions).forEach((extendName) => {
        ...
        const name = extendComponentSymbolMap.has(etsComponentName) ? 
            etsComponentName : extendComponentSymbolMap.has(etsComponentName.toString().slice(0, -8) as __String) ? 
                etsComponentName.toString().slice(0, -8) as __String : undefined;
        if (!name) {
            return;
        }
        extendComponentSymbolMap.get(name)!.forEach(local => {
            addPropertySymbol(local, /* insertAwait */ false, insertQuestionDot);
        });
    }

    function addEtsStylesPropertySymbol(node: EtsComponentExpression | CallExpression | PropertyAccessExpression | Identifier , insertQuestionDot: boolean) {
        const locals = getSourceFileOfNode(node).locals;
        if (!locals) {
            return;
        }
        ...
        locals.forEach(local => {
            ...
            const currDeclaration = isVariableDeclaration(declaration) && isVariableDeclarationList(declaration.parent) && isVariableStatement(declaration.parent.parent) ? declaration.parent.parent : declaration;
            getEtsStylesDecoratorComponentNames(getAllDecorators(currDeclaration), compilerOptions).forEach((stylesName) => {
                if (stylesComponentSymbolMap.has(stylesName)) {
                    stylesComponentSymbolMap.get(stylesName)!.push(local);
                }
                else {
                    stylesComponentSymbolMap.set(stylesName, [local]);
                }
            });
        });
        ...
        getContainingStruct(node)?.symbol.members?.forEach(member => {
            getEtsStylesDecoratorComponentNames(getAllDecorators(member.valueDeclaration), compilerOptions).forEach((stylesName) => {
                if (stylesComponentSymbolMap.has(stylesName)) {
                    stylesComponentSymbolMap.get(stylesName)!.push(member);
                }
                else {
                    stylesComponentSymbolMap.set(stylesName, [member]);
                }
            });
        });
