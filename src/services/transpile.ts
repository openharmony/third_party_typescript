import {
    ...
    Diagnostic, ensureScriptKind, fileExtensionIs, filter, forEachEntry, getDefaultCompilerOptions, getEmitScriptTarget,
    getEntries, getImpliedNodeFormatForFile, getNewLineCharacter, getSetExternalModuleIndicator, hasProperty, isString,
    Map, MapLike, normalizePath, optionDeclarations, parseCustomTypeOption, toPath, transpileOptionValueCompilerOptions,
} from "./_namespaces/ts";
