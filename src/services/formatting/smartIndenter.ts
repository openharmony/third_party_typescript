import {
    ...
    SignatureDeclaration, skipTrivia, SourceFile, SourceFileLike, StructDeclaration, SyntaxKind, TextRange,
    TypeAliasDeclaration, TypeLiteralNode, TypeReferenceNode, VariableDeclarationList,
} from "../_namespaces/ts";
    ...
    function getListByRange(start: number, end: number, node: Node, sourceFile: SourceFile): NodeArray<Node> | undefined {
        switch (node.kind) {
            ...
            case SyntaxKind.JSDocTemplateTag:
                return getList((node as ClassDeclaration | ClassExpression | StructDeclaration | InterfaceDeclaration | TypeAliasDeclaration | JSDocTemplateTag).typeParameters);
