...
import {
    CompilerOptionsValue, EndOfLineState, FileExtensionInfo, HighlightSpanKind, JsDocTagInfo, MapLike,
    OutliningSpanKind, OutputFile, PluginImport, ProjectReference, RenameLocation, ScriptElementKind, ScriptKind,
    TextChange, TextInsertion, TodoComment, TodoCommentDescriptor, TypeAcquisition,
} from "./_namespaces/ts";
