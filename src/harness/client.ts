import {
    ApplicableRefactorInfo, BuilderProgram, CallHierarchyIncomingCall, CallHierarchyItem, CallHierarchyOutgoingCall,
    Classifications, ClassifiedSpan, CodeActionCommand, CodeFixAction, CompletionEntry, CompletionEntryDetails,
    CompletionInfo, computeLineAndCharacterOfPosition, computeLineStarts, computePositionOfLineAndCharacter,
    createQueue, createTextSpanFromBounds, Debug, DefinitionInfo, DefinitionInfoAndBoundSpan, Diagnostic,
    DiagnosticCategory, DiagnosticWithLocation, DocCommentTemplateOptions, DocumentHighlights, DocumentSpan,
    EditorOptions, EmitOutput, FileTextChanges, firstDefined, FormatCodeOptions, FormatCodeSettings, getSnapshotText,
    identity, ImplementationLocation, InlayHint, InlayHintKind, isString, JSDocTagInfo, LanguageService,
    LanguageServiceHost, map, Map, mapOneOrMany, NavigateToItem, NavigationBarItem, NavigationTree, notImplemented,
    OrganizeImportsArgs, OutliningSpan, PatternMatchKind, Program, QuickInfo, RefactorEditInfo, ReferencedSymbol,
    ReferenceEntry, RenameInfo, RenameInfoFailure, RenameInfoSuccess, RenameLocation, ScriptElementKind,
    SemanticClassificationFormat, Set, SignatureHelpItem, SignatureHelpItems, SourceFile, Symbol, TextChange,
    TextInsertion, textPart, TextRange, TextSpan, TodoComment, TodoCommentDescriptor, UserPreferences,
} from "./_namespaces/ts";
