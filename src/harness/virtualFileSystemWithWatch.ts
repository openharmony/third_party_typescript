...
import {
    arrayFrom, arrayToMap, clear, clone, combinePaths, compareStringsCaseSensitive, ConditionCheckResult,
    createGetCanonicalFileName, createMultiMap, createSystemWatchFunctions, Debug, DiagnosticCategory,
    directorySeparator, ESMap, FileCheckModuleInfo, FileSystemEntryKind, FileWatcher, FileWatcherCallback,
    FileWatcherEventKind, filterMutate, forEach, FormatDiagnosticsHost, FsWatchCallback, FsWatchWorkerWatcher,
    generateDjb2Hash, getBaseFileName, getDirectoryPath, getNormalizedAbsolutePath, getRelativePathToDirectoryOrUrl,
...
export class TestServerHost implements ServerHost, FormatDiagnosticsHost, ModuleResolutionHost {
    ...
    getJsDocNodeCheckedConfig(jsDocFileCheckInfo: FileCheckModuleInfo, sourceFilePath: string): JsDocNodeCheckConfig {
