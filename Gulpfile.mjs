...
const ohTestCasesGeneration = async () => {
    ...
    if (!fs.existsSync(path.join(dirname(currentFilename), "tests/cases/fourslash/oh/")) || !fs.existsSync(path.join(dirname(currentFilename), "tests/cases/compiler-oh/"))) {
...
task("runtests", series(preBuild, ohTestCasesGeneration, preTest, runTests));
