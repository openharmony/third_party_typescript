...
/**---
 description: >
  ...
  and M is a string index signature of type U, 
  and U is the Any type or S has an apparent string index signature of a type that is assignable to U.
 module: ESNext
 isCurrent: true
 ---*/
