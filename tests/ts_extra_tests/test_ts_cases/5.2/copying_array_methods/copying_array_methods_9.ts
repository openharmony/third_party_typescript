...
const myArray = [true, false, true, false];
const reversedArray = myArray.toReversed();

Assert.equal(reversedArray[0], false);
Assert.equal(reversedArray[1], true);
Assert.equal(reversedArray[2], false);
Assert.equal(reversedArray[3], true);
