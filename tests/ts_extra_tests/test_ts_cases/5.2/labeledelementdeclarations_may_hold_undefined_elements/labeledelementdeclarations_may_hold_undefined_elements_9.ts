...
/**---
 description: >
    The labeledElementDeclarations property of TupleType may hold undefined for at each position 
    where an element is unlabeled.
 module: ESNext
 isCurrent: true
 ---*/
...
Assert.equal(JSON.stringify(tuple.labeledElementDeclarations?.concat(undefined)), JSON.stringify(tempArray));