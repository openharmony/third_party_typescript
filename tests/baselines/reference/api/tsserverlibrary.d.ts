...
declare namespace ts {
    namespace Problems {
        enum FaultID {
            ...
            ForOfNonArray = 31,
            VarDeclaration = 32,
            CatchWithUnsupportedType = 33,
            DeleteOperator = 34,
            DeclWithDuplicateName = 35,
            UnaryArithmNotNumber = 36,
            ConstructorType = 37,
            ConstructorIface = 38,
            ConstructorFuncs = 39,
            CallSignature = 40,
            ...
            ConditionalType = 44,
            MappedType = 45,
            NamespaceAsObject = 46,
            ClassAsObject = 47,
            NonDeclarationInNamespace = 48,
            GeneratorFunction = 49,
            FunctionContainsThis = 50,
            PropertyAccessByIndex = 51,
            JsxElement = 52,
            EnumMemberNonConstInit = 53,
            ImplementsClass = 54,
            NoUndefinedPropAccess = 55,
            MultipleStaticBlocks = 56,
            ThisType = 57,
            IntefaceExtendDifProps = 58,
            StructuralIdentity = 59,
            TypeOnlyImport = 60,
            TypeOnlyExport = 61,
            DefaultImport = 62,
            ExportAssignment = 63,
